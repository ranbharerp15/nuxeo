 ...
 * @since 11.1
 */
@Deploy("org.nuxeo.ecm.platform.convert.test:OSGI-INF/test-bypass-contrib.xml")
public class TestBypassOverride extends BaseConverterTest {
    ...
    @Deploy("org.nuxeo.ecm.platform.convert.test:OSGI-INF/test-bypass-override-contrib.xml")
    @Test
